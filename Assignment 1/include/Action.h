...
class BaseAction{
    public:
        ...
        const string change() const;
        const CustomerType change1(const string &other) const;
        const string change2(CustomerType other) const;

        void setStatus(ActionStatus other);
        void setErrorMsg(string other);
